...
def response(user_prompt):
    try:
        model = genai.GenerativeModel("gemini-1.5-pro-latest",system_instruction="You are a helpful AI Assitance named Ai Assistance")
        ...
        st.write(f"Error Occured while accessing the api {e}")
